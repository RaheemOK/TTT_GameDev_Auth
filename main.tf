...
output "vm_external_ip" {
  value = data.google_compute_address.existing_static_address != null ? data.google_compute_address.existing_static_address.address : google_compute_address.static_address.address
}
